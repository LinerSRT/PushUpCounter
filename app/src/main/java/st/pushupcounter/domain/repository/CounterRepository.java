package st.pushupcounter.domain.repository;
...
public interface CounterRepository<COUNTER_TYPE> {
     ...
     */
    @NonNull
    String toCSV(Formatter<COUNTER_TYPE> formatter) throws IOException;

    @FunctionalInterface
    interface Formatter<COUNTER_TYPE> {
        String apply(COUNTER_TYPE c);
    }
}
