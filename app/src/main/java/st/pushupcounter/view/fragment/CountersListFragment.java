...
import st.pushupcounter.view.adapter.CountersListAdapter;
import st.pushupcounter.view.fragment.dialog.AddDialog;
...
public class CountersListFragment extends ListFragment {
    ...
    public View onCreateView(
        ...
        @SuppressLint("InflateParams") final View view = inflater.inflate(R.layout.menu, null);
